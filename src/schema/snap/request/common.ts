...
export const BillingAddressOptions = z.object({
...
export const ItemDetailsOptions = z.object({
...
export const ShippingDetailOptions = z.object({
  first_name: z.string(),
  last_name: z.string(),
  email: z.string(),
  phone: z.string(),
...
export const CustomerDetailOptions = z.object({
  first_name: z.string(),
  last_name: z.string(),
  email: z.string(),
  phone: z.string(),
